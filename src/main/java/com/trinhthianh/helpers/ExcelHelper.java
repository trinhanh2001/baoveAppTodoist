package com.trinhthianh.helpers;
...
public class ExcelHelper {
    ...
    public Object[][] getExcelData(String fileName, String sheetName) {
        ...
        try {
            ...
            workbook = new XSSFWorkbook(fis); //read file excel .xlsx bằng đối tượng XSSFWorkbook của Apache POI
    ...
    public Object[][] getDataHashTable(String excelPath, String sheetName, int startRow, int endRow) {
        ...
        try {
            ...
            data = new Object[(endRow - startRow) + 1][1];  //tạo mảng với số hàng và mõi hàng chỉ chứa 1 phần tử
            Hashtable<String, String> table = null;
            for (int rowNums = startRow; rowNums <= endRow; rowNums++) {
                table = new Hashtable<>();
                for (int colNum = 0; colNum < columns; colNum++) {
                    //thêm 1 cặp key-value vào table, key sd lấy DL dòng đầu(0) cột colNum( tên cột), value thứ 2 lấy DL tương ứng dòng và cột
                    table.put(getCellData(0, colNum), getCellData(rowNums, colNum));
                }
                data[rowNums - startRow][0] = table; //gán dữ liệu từ các ô trong hàng hiện tại vào mảng data.
            }
